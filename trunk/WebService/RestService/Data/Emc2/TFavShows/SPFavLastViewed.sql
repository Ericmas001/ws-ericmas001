...
GO
IF OBJECT_ID('SPFavLastViewed') IS NOT NULL
DROP PROC SPFavLastViewed
GO
-- =============================================
-- Author:		ericmas001
...
-- Description:	Set 
-- =============================================
CREATE PROCEDURE SPFavLastViewed 
	-- Add the parameters for the stored procedure here
	@username NVARCHAR(50),
	@session NVARCHAR(32),
	@website NVARCHAR(50), 
	@name NVARCHAR(50), 
	@lastViewedSeason INT,
	@lastViewedEpisode INT,
	@ok BIT OUT,
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			IF @ok = 1
				UPDATE [ericmas001].[TFavShows] SET lastViewedSeason = @lastViewedSeason,  lastViewedEpisode = @lastViewedEpisode WHERE idUser = @idUser AND idShow = @idShow
			ELSE
